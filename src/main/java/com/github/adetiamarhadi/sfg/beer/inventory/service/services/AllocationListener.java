...
public class AllocationListener {
    ...
    public void listen(AllocateOrderRequest request) {
        ...
        try {
            ...
            Boolean allocationResult = this.allocationService.allocateOrder(request.getBeerOrderDto());
            if (allocationResult) {
        ...
        this.jmsTemplate.convertAndSend(JmsConfig.ALLOCATE_ORDER_RESPONSE_QUEUE, builder.build());
    }
}
